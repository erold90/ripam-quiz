import QuizMateriaClient from '../../quiz/[materia]/QuizMateriaClient';
...
export default function RipassoMateriaPage({
  params,
}: {
  params: Promise<{ materia: string }>;
}) {
  return <QuizMateriaClient paramsPromise={params} modalita="ripasso" />;
}
